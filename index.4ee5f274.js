function t(t,e,r,n){Object.defineProperty(t,e,{get:r,set:n,enumerable:!0,configurable:!0})}var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},n={},o=e.parcelRequired7c6;null==o&&((o=function(t){if(t in r)return r[t].exports;if(t in n){var e=n[t];delete n[t];var o={id:t,exports:{}};return r[t]=o,e.call(o.exports,o,o.exports),o.exports}var i=Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(t,e){n[t]=e},e.parcelRequired7c6=o),o.register("9dxg1",function(e,r){t(e.exports,"fetchBreeds",function(){return i}),t(e.exports,"fetchCatByBreed",function(){return a}),o("2shzp");var n=o("bRlFp");async function i(){try{let t=await (0,n.default).get("https://api.thecatapi.com/v1/breeds"),e=t.data,r=document.getElementById("breedSelect");e.forEach(t=>{let e=document.createElement("option");e.value=t.id,e.textContent=t.name,r.appendChild(e)})}catch(t){console.error("Failed to fetch breeds:",t)}}async function a(t){try{let e=await (0,n.default).get(`https://api.thecatapi.com/v1/images/search?breed_ids=${t}`),r=e.data[0],o=document.querySelector(".cat-name"),i=document.querySelector(".cat-description"),a=document.querySelector(".cat-temperament"),u=document.querySelector(".cat-image"),s=document.querySelector(".loader"),f=document.querySelector("#catInfo"),l=document.querySelector(".error");l.style.display="none",s.style.display="block",f.style.display="none",o.textContent="",i.textContent="",a.textContent="",r&&r.url?u.src=r.url:(l.style.display="block",s.style.display="none",f.style.display="none"),o.textContent=r.breeds[0].name,i.textContent=r.breeds[0].description,a.textContent=r.breeds[0].temperament,s.style.display="none",f.style.display="block"}catch(t){console.error("Failed to fetch cat by breed:",t),error.style.display="block",loader.style.display="none",catInfo.style.display="none"}}n.default.defaults.headers.common["x-api-key"]="live_eqler4EWYhATUvmkyfWWvZAYI5F22zRTOaSRTN2UCSGgCnHXjdMB3hKouA6Rb5VJ"}),o.register("2shzp",function(e,r){t(e.exports,"default",function(){return o("bRlFp").default});var n=o("bRlFp");// This module is intended to unwrap Axios default export as named.
...
let i=r?Object.getOwnPropertyNames(t):Object.keys(t),a=i.length;for(n=0;n<a;n++)o=i[n],e.call(null,t[o],o,t)}}}function x(t,e){let r;e=e.toLowerCase();let n=Object.keys(t),o=n.length;for(;o-- >0;)if(e===(r=n[o]).toLowerCase())return r;return null}let T=/*eslint no-undef:0*/"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:e,U=t=>!p(t)&&t!==T,C=(a="undefined"!=typeof Uint8Array&&f(Uint8Array),t=>a&&t instanceof a),N=c("HTMLFormElement"),I=(({hasOwnProperty:t})=>(e,r)=>t.call(e,r))(Object.prototype),j=c("RegExp"),L=(t,e)=>{let r=Object.getOwnPropertyDescriptors(t),n={};S(r,(r,o)=>{let i;!1!==(i=e(r,o,t))&&(n[o]=i||r)}),Object.defineProperties(t,n)},P="abcdefghijklmnopqrstuvwxyz",_="0123456789",F={DIGIT:_,ALPHA:P,ALPHA_DIGIT:P+P.toUpperCase()+_},k=c("AsyncFunction");var D={isArray:h,isArrayBuffer:g,isBuffer:/**
 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&g(t.buffer)},isString:y,isNumber:b,isBoolean:t=>!0===t||!1===t,isObject:E,isPlainObject:w,isUndefined:p,isDate:v,isFile:B,isBlob:A,isRegExp:j,isFunction:m,isStream:t=>E(t)&&m(t.pipe),isURLSearchParams:R,isTypedArray:C,isFileList:O,forEach:S,merge:/**
...
let o=!1;for(;;)switch(e){case"ascii":case"latin1":case"binary":return r;case"utf8":case"utf-8":return F(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*r;case"hex":return r>>>1;case"base64":return k(t).length;default:if(o)return n?-1:F(t).length// assume utf8
...
if(o=null,r<128){if((e-=1)<0)break;i.push(r)}else if(r<2048){if((e-=2)<0)break;i.push(r>>6|192,63&r|128)}else if(r<65536){if((e-=3)<0)break;i.push(r>>12|224,r>>6&63|128,63&r|128)}else if(r<1114112){if((e-=4)<0)break;i.push(r>>18|240,r>>12&63|128,r>>6&63|128,63&r|128)}else throw Error("Invalid code point")}return i}function k(t){return a.toByteArray(function(t){// Node converts strings with length < 2 to ''
