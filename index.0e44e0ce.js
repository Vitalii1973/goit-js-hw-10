!function(){function t(t,e,r,n){Object.defineProperty(t,e,{get:r,set:n,enumerable:!0,configurable:!0})}var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},n={},i=e.parcelRequired7c6;null==i&&((i=function(t){if(t in r)return r[t].exports;if(t in n){var e=n[t];delete n[t];var i={id:t,exports:{}};return r[t]=i,e.call(i.exports,i,i.exports),i.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){n[t]=e},e.parcelRequired7c6=i),i.register("eWrZJ",function(e,r){t(e.exports,"fetchBreeds",function(){return o}),t(e.exports,"fetchCatByBreed",function(){return u}),i("dIxxU");var n=i("ke5Oc");async function o(){try{let t=await (0,n.default).get("https://api.thecatapi.com/v1/breeds"),e=t.data,r=document.getElementById("breedSelect");e.forEach(t=>{let e=document.createElement("option");e.value=t.id,e.textContent=t.name,r.appendChild(e)})}catch(t){console.error("Failed to fetch breeds:",t)}}async function u(t){let e=document.querySelector(".cat-name"),r=document.querySelector(".cat-description"),i=document.querySelector(".cat-temperament"),o=document.querySelector(".cat-image"),u=document.querySelector(".loader"),a=document.querySelector("#catInfo"),s=document.querySelector(".error");// Сховати селект і блок з інформацією про попередню породу, показати лоадер
document.querySelector(".breed-select").style.display="none",a.style.display="none",u.style.display="block",// error.style.display = 'none';
e.textContent="",r.textContent="",i.textContent="",o.src="";try{let u=await (0,n.default).get(`https://api.thecatapi.com/v1/images/search?breed_ids=${t}`),a=u.data[0];a&&a.url?o.src=a.url:o.src="placeholder.jpg",e.textContent=a.breeds[0].name,r.textContent=a.breeds[0].description,i.textContent=a.breeds[0].temperament}catch(t){console.error("Failed to fetch cat by breed:",t),// Показати помилку та сховати інші елементи
s.style.display="block",a.style.display="none"}finally{// Сховати лоадер після завершення запиту
u.style.display="none"}// Показати селект після завершення запиту
document.querySelector(".breed-select").style.display="block",a.style.display="block"}n.default.defaults.headers.common["x-api-key"]="live_eqler4EWYhATUvmkyfWWvZAYI5F22zRTOaSRTN2UCSGgCnHXjdMB3hKouA6Rb5VJ"}),i.register("dIxxU",function(e,r){t(e.exports,"default",function(){return i("ke5Oc").default});var n=i("ke5Oc");// This module is intended to unwrap Axios default export as named.
