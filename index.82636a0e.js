function t(t,e,r,n){Object.defineProperty(t,e,{get:r,set:n,enumerable:!0,configurable:!0})}var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},n={},o=e.parcelRequired7c6;null==o&&((o=function(t){if(t in r)return r[t].exports;if(t in n){var e=n[t];delete n[t];var o={id:t,exports:{}};return r[t]=o,e.call(o.exports,o,o.exports),o.exports}var i=Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(t,e){n[t]=e},e.parcelRequired7c6=o),o.register("9dxg1",function(e,r){t(e.exports,"fetchBreeds",function(){return i}),t(e.exports,"fetchCatByBreed",function(){return a}),o("2shzp");var n=o("bRlFp");async function i(){try{let t=await (0,n.default).get("https://api.thecatapi.com/v1/breeds"),e=t.data,r=document.getElementById("breedSelect");e.forEach(t=>{let e=document.createElement("option");e.value=t.id,e.textContent=t.name,r.appendChild(e)})}catch(t){console.error("Failed to fetch breeds:",t)}}async function a(t){let e=document.querySelector(".cat-name"),r=document.querySelector(".cat-description"),o=document.querySelector(".cat-temperament"),i=document.querySelector(".cat-image"),a=document.querySelector(".loader"),u=document.querySelector("#catInfo"),s=document.querySelector(".error");// Сховати селект і блок з інформацією про попередню породу, показати лоадер
document.querySelector(".breed-select").style.display="none",u.style.display="none",a.style.display="block",// error.style.display = 'none';
e.textContent="",r.textContent="",o.textContent="",i.src="";try{let a=await (0,n.default).get(`https://api.thecatapi.com/v1/images/search?breed_ids=${t}`),u=a.data[0];u&&u.url?i.src=u.url:i.src="placeholder.jpg",e.textContent=u.breeds[0].name,r.textContent=u.breeds[0].description,o.textContent=u.breeds[0].temperament}catch(t){console.error("Failed to fetch cat by breed:",t),// Показати помилку та сховати інші елементи
s.style.display="block",u.style.display="none"}finally{// Сховати лоадер після завершення запиту
a.style.display="none"}// Показати селект після завершення запиту
document.querySelector(".breed-select").style.display="block",u.style.display="block"}n.default.defaults.headers.common["x-api-key"]="live_eqler4EWYhATUvmkyfWWvZAYI5F22zRTOaSRTN2UCSGgCnHXjdMB3hKouA6Rb5VJ"}),o.register("2shzp",function(e,r){t(e.exports,"default",function(){return o("bRlFp").default});var n=o("bRlFp");// This module is intended to unwrap Axios default export as named.
